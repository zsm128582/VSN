...
class HalfRestormer(nn.Module):
    def __init__(
        ...
        super(HalfRestormer, self).__init__()
...
@register_model
def HalfRestomer_defalt(args):
    model = HalfRestormer(inp_channels=3, dim=48)
